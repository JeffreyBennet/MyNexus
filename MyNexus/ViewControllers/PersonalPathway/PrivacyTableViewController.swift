...
let defaults = UserDefaults.standard
   ...
   {
       let Header = UIView(frame: CGRect(x: 0, y: 0, width: Double(self.tableView.frame.size.width), height: 60))
       Header.backgroundColor = UIColor(named: "newGray")
       let button = UIButton()
        button.frame = CGRect(x:30 , y: 20, width: 40 , height: Header.frame.size.height)
    ...
    */
    ...
    /*
    // Override to support conditiol editing of the table view.
